        ...
        sectionDetails = this.state.sections.map((section) => {
            return (
                <div className="col-md-4">
                    <div className="card">
                        <button className="btn btn-outline-danger text-center text-dark" onClick={() => this.selectItems(section.itemType)}>{section.itemType}</button>
                    </div>
                </div>
            )
        })
                ...
                <div className="col-md-6">
                    <div className="card">
                        <div className="card-body">
                            ...
                            {/* <button className="btn btn-outline-danger" onClick={this.editItem}>Edit</button> */}
                            <Link to={{
                                pathname: `/edititem`,
                                item: item
